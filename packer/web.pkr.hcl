...
source "amazon-ebs" "web" {
  ...
  ami_name      = "concourse-web-${var.concourse_version}-${local.timestamp}"
  ami_description = "Concourse web node - concourse v${var.concourse_version}"
...
build {
  ...
  provisioner "file" {
    source      = "files/concourse-web.service"
    destination = "/tmp/concourse-web.service"
  }
